...
public class CompilationFailureTest {
	...
	public void test() throws Exception {
		assertNotNull("Test build script file is missing", getClass()
				.getResource("/basic_build_script.xml"));
		...
		assertEquals(REV1, finalContent);
