...
public class FieldNode extends CGNode {
	...
	public FieldNode(String fieldName, String className, String fieldType) {
		fType = fieldType;
		fQuantifiedName = BytecodeUtils.getQualifiedFieldName(fieldName,
				className, fType);
	}

	@Override
	public String toString() {
		return "FIELD: " + fQuantifiedName;
	}
